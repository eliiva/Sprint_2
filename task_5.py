...
class Football(Results):
    ...
    def number_of_wins(self):
        return f'Футбольных побед: {self.victorise}'
    ...
    def total_points(self):
        total_points = 3 * self.victorise + self.draws
...
class Hockey(Results):
    ...
    def number_of_wins(self):
        return f'Хоккейных побед: {self.victorise}'
    ...
    def total_points(self):
        total_points = 2 * self.victorise + self.draws
        return f'Общее количество очков: {total_points}'
